...
# # Data paths
# data_path = 'task_IFD.json'
# output_file = 'task_LCTW_IFD.json'
...
#         messages = [
#             {"role": "system", "content": "You are an assistant who is good at following instructions."},
#             {"role": "user", "content": f"{instruction}\n\n{input_text}"}
#         ]
#         try:
...
for i, item in enumerate(tqdm(dataset, desc="🚀 处理数据", unit="条")):
    ...
    model_output = translate(system_content, instruction_ti, output_en, history)
