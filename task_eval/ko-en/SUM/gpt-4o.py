...
#
# # 📂 定义文件路径
# input_file = "/data/zhenmengyuan/LLaMA-Factory/data/ko_data/eval_SUM.json"
# output_dir = "/data/zhenmengyuan/LLaMA-Factory/saves/task_eval/ko-en/SUM/"
...
#     task_data.append({
#         "instruction": "Please complete the text summarization task based on the following text without any extra explanation.",
#         "input": item["text_ko"],
#         "output": item["sum_ko"]
#     })
#
