...
output_results_file = "deepseek-R1_outputs.json"
eval_results_file = "deepseek-R1_results.json"
...
# **OpenAI API 调用**
def get_gpt4o_response(instruction, input_text):
...
#
# # 加载 JSON 文件
# with open('deepseek-R1_outputs.json', 'r', encoding='utf-8') as f:
#     data = json.load(f)
#
